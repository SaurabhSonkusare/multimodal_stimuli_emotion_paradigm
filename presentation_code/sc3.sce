...
array { 
       ...
       video { filename = "Clip_21_KILL_BIL_VOL1_Vernita_Green_fight.avi"; description = "46"; width = 1370; height = 900;}V1;

       video { filename = "Clip_24_Love_Actually_-_All_you_need_is_Love_Wedding_Scene.avi"; description = "47"; width = 1370; height = 900;};

       video { filename = "Clip_34_PARANORMAL_ACTIVITY_GROWL.avi";description = "48"; width = 1370; height = 900;};

       video { filename = "Clip_08_DEAD_POETS_SOCIETY_desk_scene.avi";description = "49"; width = 1370; height = 900;};

       video { filename = "Clip_42_Saving_Private_Ryan_short.avi";description = "50";width = 1370; height = 900;};

} emotional_films;


array {
   sound { wavefile { filename = "013_HV_HA_Happy.wav";}; description = "59"; } M1;
   sound { wavefile { filename = "125_LV_HA_Anger.wav";}; description = "60"; };
   sound { wavefile { filename = "192_HV_HA_Happy.wav";}; description = "61"; };
   sound { wavefile { filename = "123_LV_HA_Anger.wav";}; description = "56"; };
...
#		loop int k = 1 until k > emotional_pics_HV.count() begin
   ...
   empty_trial.present();
	...
	fix_trial.present ();
   empty_trial.present();  
	emotional_pics_LV.shuffle();
	
	loop int x = 1 until x > 8 begin

		 #emotional_pics_LV.shuffle();
		 main_pic.set_part( 1, emotional_pics_LV[x] );
		 main_event.set_event_code( emotional_pics_LV[x].description() );
		 main_event.set_port_code( int( emotional_pics_LV[x].description() ) );
