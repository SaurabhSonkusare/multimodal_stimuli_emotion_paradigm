...
array { 
       ...
       video { filename = "Clip_13_GREY_THE_WOLF_CHASE_ED.avi"; description = "41"; width = 1370; height = 900;}V1;

       video { filename = "Clip_41_SHINING_THE_Here_s_Johnny.avi"; description = "42"; width = 1370; height = 900;};

       video { filename = "Clip_25_Love_Actually_-_Dancing_Prime_Minister.avi";description = "43"; width = 1370; height = 900;};

       video { filename = "Clip_31_Mr.Bean_s_Holiday_(Dance_Scene_HD.avi";description = "44"; width = 1370; height = 900;};

       video { filename = "Clip_40_REQUIEM_FOR_A_DREAM_NEEDLE.avi";description = "45";width = 1370; height = 900;};

} emotional_films;


array {
   sound { wavefile { filename = "009_HV_HA_Happy.wav";}; description = "55"; } M1;
   sound { wavefile { filename = "123_LV_HA_Anger.wav";}; description = "56"; };
   sound { wavefile { filename = "127_LV_HA_Anger.wav";}; description = "57"; };
...
#		loop int k = 1 until k > emotional_pics_HV.count() begin
   ...
   empty_trial.present();
	...
	loop int x = 1 until x > 8 begin
		 ...
		 #emotional_pics_NV.shuffle();
		 main_pic.set_part( 1, emotional_pics_NV[x] );
		 main_event.set_event_code( emotional_pics_NV[x].description() );
		 main_event.set_port_code( int( emotional_pics_NV[x].description() ) );
